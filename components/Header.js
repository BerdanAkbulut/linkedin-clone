...
function Header() {
  ...
  return (
    <header
     ...
     dark:bg-[#1D2226] flex items-center justify-around  py-1.5 px-3 focus-within:shadow-lg"
    >
      {/* Left */}
      ...
      <div className="flex items-center space-x-6">
        ...
        {/* DarkModeToggle */}
        {
          ...
          className={`bg-gray-600 flex items-center px-0.5 rounded-full
           h-6 w-12 cursor-pointer flex-shrink-0 relative ${resolvedTheme ==="dark" ? "justify-end" : "justify-start" }`
           }
