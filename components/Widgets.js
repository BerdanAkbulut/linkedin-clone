...
function Widgets({ articles }) {
  ...
  return (
    <div className="  sm:hidden md:hidden relative max-w-lg xl:h-1/3 md:h-1/3 sm:h-1/3 xs:h-1/3 overflow-hidden  dark:bg-gray-800/80 py-2 px-2 text-md font-medium border border-gray-400 dark:border-none rounded-lg dark:text-white/75  text-black ">
